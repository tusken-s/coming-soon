  ...
  return (
    <>
      ...
      <article className="mx-auto px-4 py-8 max-w-screen-lg">
        ...
        <br />
        <h1 className="text-yellow-300">General Terms</h1>
        <p>
          <span>
            By accessing and placing an order with us, you confirm that you are
            in agreement with and bound by the terms of service contained in the
            Terms &amp; Conditions outlined below. These terms apply to the
            ...
            or the inability to use, the materials on this site, even if our
            ...
            or data, you assume any costs thereof. <br />
            <br />
        ...
        <h1 className="text-yellow-300">License</h1>
        <p>
          <span>
            ...
            (referred to in these Terms &amp; Conditions as &quot;Tuskens&quot;,
            &quot;us&quot;, &quot;we&quot; or &quot;our&quot;), the provider of
            the Tuskens website and the services accessible from the Tuskens
        ...
        <h1 className="text-yellow-300">Definitions and key terms</h1>
        <p>
        ...
        <ul>
          ...
          <li>
            <span>
              ...
              “we,” “us,” or “our,” it refers to Tuskens MEA, BP912, Sousse Bab
              bhar, 4000, Tunisia that is responsible for your information under
              this Privacy Policy.
              <br />
            </span>
          </li>
          <li>
            <span>
              ...
              Tuskens are based, in this case is Tunisia.
              <br />
            </span>
          </li>
          <li>
          ...
          <li>
            <span>
              ...
              visit Tuskens and use the services.
              <br />
            </span>
          </li>
          <li>
          ...
          <li>
            <span>
              ...
              employed by Tuskens or are under contract to perform a service on
          ...
          <li>
            <span>
              ...
              Tuskens as described in the relative terms (if available) and on
              this platform.
              <br />
            </span>
          </li>
          ...
          <li>
            <span>
              <strong>Website:</strong> Tuskens’s site, which can be accessed
              via this URL:{" "}
              <a href="https://tuskens.com">https://tuskens.com.</a>
              <br />
            </span>
          </li>
          <li>
        ...
        <h1 className="text-yellow-300">Restrictions</h1>
        <p>
        ...
        <p>
          <span>
            ...
            indicated in an order form, you must provide us with a valid credit
            card (Visa, MasterCard, or any other issuer accepted by us)
            ...
            respect to your Payment Provider. By providing us with your credit
            card number and associated payment information, you agree that we
            are authorized to verify information immediately, and subsequently
            ...
            agree to immediately notify us of any change in your billing address
            or the credit card used for payment hereunder. We reserve the right
            ...
            organization’s administrator(s). Any attorney fees, court costs, or
            other costs incurred in collection of delinquent undisputed amounts
            shall be the responsibility of and paid for by you. No contract will
            exist between you and us for the Service until we accept your order
            by a confirmatory e-mail, SMS/MMS message, or other appropriate
        ...
        <h1 className="text-yellow-300">Return and Refund Policy</h1>
        <p>
          <span>
        ...
        <h1 className="text-yellow-300">Your Suggestions</h1>
        <p>
          <span>
        ...
        <h1 className="text-yellow-300">Your Consent</h1>
        <p>
          <span>
        ...
        <h1 className="text-yellow-300">Links to Other Websites</h1>
        <p>
          <span>
        ...
        <h1 className="text-yellow-300">Cookies</h1>
        <p>
          <span>
        ...
        <h1 className="text-yellow-300">Modifications to Our service</h1>
        <p>
          <span>
        ...
        <h1 className="text-yellow-300">Updates to Our service</h1>
        <p>
          <span>
        ...
        <h1 className="text-yellow-300">Third-Party Services</h1>
        <p>
          <span>
        ...
        <h1 className="text-yellow-300">Term and Termination</h1>
        <p>
          <span>
        ...
        <h1 className="text-yellow-300">Indemnification</h1>
        <p>
          <span>
        ...
        <h1 className="text-yellow-300">No Warranties</h1>
        <p>
          <span>
        ...
        <h1 className="text-yellow-300">Limitation of Liability</h1>
        <p>
          <span>
        ...
        <h1 className="text-yellow-300">Severability</h1>
        <p>
          <span>
        ...
        <h1 className="text-yellow-300">Waiver</h1>
        <p>
          <span>
        ...
        <h1 className="text-yellow-300">Amendments to this Agreement</h1>
        <p>
          <span>
        ...
        <h1 className="text-yellow-300">Entire Agreement</h1>
        <p>
          <span>
        ...
        <h1 className="text-yellow-300">Updates to Our Terms</h1>
        <p>
          <span>
        ...
        <h1 className="text-yellow-300">Intellectual Property</h1>
        <p>
          <span>
        ...
        <h1 className="text-yellow-300">Agreement to Arbitrate</h1>
        <p>
          <span>
            ...
            REGARDING THE ENFORCEMENT OR VALIDITY OF YOUR OR Tuskens’s
        ...
        <h1 className="text-yellow-300">Notice of Dispute</h1>
        <p>
          <span>
        ...
        <h1 className="text-yellow-300">Binding Arbitration</h1>
        <p>
          <span>
        ...
        <h1 className="text-yellow-300">Submissions and Privacy</h1>
        <p>
          <span>
        ...
        <h1 className="text-yellow-300">Promotions</h1>
        <p>
          <span>
        ...
        <h1 className="text-yellow-300">Typographical Errors</h1>
        <p>
          <span>
        ...
        <h1 className="text-yellow-300">Miscellaneous</h1>
        <p>
          <span>
        ...
        <h1 className="text-yellow-300">Disclaimer</h1>
        <p>
          <span>
        ...
        <h1 className="text-yellow-300">Contact Us</h1>
        <p>
          <span>
        ...
        <ul>
          <li>
            <span>
              Via Email:{" "}
              <a href="mailto:hello@tuskens.com">hello@tuskens.com</a>
            </span>
          </li>
          <li>
            <span>
              Via Phone Number: <a href="tel:+21697052688">+216 97 052 688</a>
            </span>
          </li>
          <li>
            <span>
              Via this Link:
              <a href="/contact">https://tuskens.com/contact</a>
            </span>
          </li>
          <li>
            <span>Via this Address: BP912, Sousse Bab bhar, 4000, Tunisia</span>
          </li>
        </ul>
      </article>
